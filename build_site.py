...
def header(prefix=''):
    return f'''<header class="site-header"><div class="shell nav-wrap"><a class="brand" href="{prefix}"><img src="/assets/logo-tf.png" alt="Traços Fidalgos"><span>Traços Fidalgos</span></a><button class="nav-toggle" aria-label="Menu">☰</button><nav class="nav"><a href="{prefix}atelier/">Atelier</a><a href="{prefix}servicos/">Serviços</a><a href="{prefix}catalogos/">Portfólio</a><a href="{prefix}processo/">Processo</a><a href="{prefix}paris/">Paris</a><a href="{prefix}contacto/">Contacto</a><a class="pill" href="{WA}">WhatsApp</a><span class="lang"><a href="{prefix}">PT</a><a href="{prefix}en/">EN</a><a href="{prefix}fr/">FR</a></span></nav></div></header>'''
